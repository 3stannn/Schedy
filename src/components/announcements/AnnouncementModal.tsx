        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-7 space-y-5">
          ...
          {priority === 'dev' && (
            ...
            <div className="space-y-2.5 pt-3 border-t border-neutral-100 dark:border-neutral-800 text-xs">
              ...
              <div className="flex items-center gap-3 py-1">
                ...
                <select
                  ...
                  className={`px-2.5 py-1 rounded text-xs border-none outline-none focus:ring-1 cursor-pointer font-semibold ${
                    priority === 'dev'
            ...
            <div className="flex items-center justify-end gap-2 pt-3 border-t border-neutral-100 dark:border-neutral-800">
              ...
              <button
                type="submit"
                className={`px-3.5 py-1 text-xs font-semibold text-white rounded-lg shadow-xs transition-all active:scale-95 flex items-center gap-1.5 ${
                  priority === 'dev'
